...
@interface test_longpress_pinchObject : KrollCoverageObject {
#else
@interface test_longpress_pinchObject : KrollObject {
#endif
@private
...
extern NSString * test_longpress_pinch$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	test_longpress_pinchObject *_test_longpress_pinch;
	BOOL shutdown;

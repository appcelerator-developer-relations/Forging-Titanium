...
//@interface test_longpress_pinchObject : NSObject
//@end

@interface test_longpress_pinchObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[test_longpress_pinchObject class]])
		{
			for (NSString *key in [[(test_longpress_pinchObject*)o modules] allKeys])
			{

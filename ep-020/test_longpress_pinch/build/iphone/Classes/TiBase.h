...
// in simulator we redefine to format for test_longpress_pinch Developer console
...
{\
	NSString * exceptionName = [@"org.test_longpress_pinch." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.test_longpress_pinch";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItest_longpress_pinchNativeItemNone = -1, 
	UItest_longpress_pinchNativeItemSpinner = -2,
	UItest_longpress_pinchNativeItemProgressBar = -3,
	
	UItest_longpress_pinchNativeItemSlider = -4,
	UItest_longpress_pinchNativeItemSwitch = -5,
	UItest_longpress_pinchNativeItemMultiButton = -6,
	UItest_longpress_pinchNativeItemSegmented = -7,
	
	UItest_longpress_pinchNativeItemTextView = -8,
	UItest_longpress_pinchNativeItemTextField = -9,
	UItest_longpress_pinchNativeItemSearchBar = -10,
	
	UItest_longpress_pinchNativeItemPicker = -11,
	UItest_longpress_pinchNativeItemDatePicker = -12,
	
	UItest_longpress_pinchNativeItemInfoLight = -13,
	UItest_longpress_pinchNativeItemInfoDark = -14,
	
	UItest_longpress_pinchNativeItemDisclosure = -15,
	
	UItest_longpress_pinchNativeItemContactAdd = -16
};
